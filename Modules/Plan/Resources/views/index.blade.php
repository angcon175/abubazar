                        ...
                        <div class="row">
                            <div class="col-6">
                                @if (userCan('plan.update'))
                                    <a href="{{ route('module.plan.edit', $plan->id) }}" class="plan-card__select-pack btn btn--bg card_footer-bg">
                            ...
                            <div class="col-6">
                                @if (userCan('plan.delete'))
                                    <form action="{{ route('module.plan.delete', $plan->id) }}" class="plan-card__select-pack card_footer-bg" method="POST" onclick="return confirm('Are You Sure?')">
                                        @csrf
                                        @method('delete')
