...
class Cms extends Model
{
    ...
    protected $fillable = [
        'index1_main_banner',
        'index1_counter_background',
        'index1_mobile_app_banner',
        'index2_search_filter_background',
        'index2_get_membership_background',
        'index3_search_filter_background',
        'terms_background',
        'terms_body',
        'about_video_thumb',
        'about_body',
        ...
        'privacy_body',
        'contact_background',
        'get_membership_background',
        'get_membership_image',
        'pricing_plan_background',
        'faq_background',
        'dashboard_overview_background',
        'dashboard_post_ads_background',
        'dashboard_my_ads_background',
        'dashboard_plan_background',
        'dashboard_account_setting_background',
        'posting_rules_background',
        'posting_rules_body',
        'about_background',
        'dashboard_favorite_ads_background',
        'dashboard_messenger_background',
        'blog_background',
        'ads_background',
        'index1_title',
        'index3_title',
