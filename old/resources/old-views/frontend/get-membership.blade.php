                ...
                <div class="col-xl-6">
                    <div class="membership-card">
                        ...
                        <div class="membership-card__info">
                            ...
                            <p class="membership-card__description">{{ __('special_badges_for_your_ads_description') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="membership-card">
                        ...
                        <div class="membership-card__info">
                            ...
                            <p class="membership-card__description">{{ __('dedicated_customer_support_description') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="membership-card">
                        ...
                        <div class="membership-card__info">
                            <h2 class="membership-card__title text--body-1">{{ __('advertise_your_brand_on_adlisting') }}</h2>
