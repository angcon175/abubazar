                        ...
                        <div class="registration-form__wrapper">
                            <form method="POST" action="{{ route('customer.password.update') }}">
                                ...
                                <div class="input-field d-none">
                                    <input type="email" placeholder="{{ __('email_address') }}" name="email" value="{{ request('email','') }}"  class="@error('email') is-invalid border-danger @enderror" />
                                    @error('email')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="input-field">
                                    <input type="password" placeholder="{{ __('new_password') }}" id="password" name="password" class="@error('password') is-invalid border-danger @enderror" />
                                ...
                                <div class="input-field">
                                    <input type="password" placeholder="{{ __('confirm_password') }}" id="confirmPassword" name="password_confirmation" class="@error('password_confirmation') is-invalid border-danger @enderror" />
