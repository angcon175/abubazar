<div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}"><img class="brand-logo" alt="modern admin logo" src="{{asset($setting->logo ?? '')}}">
                <h3 class="brand-text" style="font-size: 12px;">DALAL BAZAR</h3>
            </a></li>
        ...
        <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item" style="position: absolute;right:0px;">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">{{ Auth::user()->username ?? '' }}</span><span class="avatar avatar-online">
                    @if(getProfile()->profile_pic_url)
                    <img src="{{getProfile()->profile_pic_url}}" alt="User">
                    @else 
