                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="image_position" class="form-control">
                                                        <option value="1" selected>Slider Bottom Ads</option>
                                                        <option value="0">Category Bottom Ads</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" action="{{ route('admin.ads.update',$adminad->id) }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="image_position" class="form-control">
                                                                    <option value="1" @if($adminad->image_position == 1) selected @endif > Slider Bottom Ads</option>
                                                                    <option value="0" @if($adminad->image_position == 0) selected @endif > Category Bottom Ads</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
