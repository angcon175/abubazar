        ...
        <div class="card-header">
            <ul class="nav nav-pills mb-3" id="cms-pills-tab" role="tablist">
               ...
               <!--  <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link " id="ads-tab" data-toggle="pill" href="#cms-ads" role="tab" aria-controls="ads"
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link " id="faq-tab" data-toggle="pill" href="#cms-faq" role="tab" aria-controls="faq"
            ...
            <div class="tab-content" id="cms-pills-tabContent">
                ...
                <div class="tab-pane fade" id="cms-terms" role="tabpanel" aria-labelledby="terms-tab">
                    <x-backend.setting.cms.terms-condition-setting :terms="$cms->terms_body"
                        :termsBackground="$cms->terms_background_path" />
                </div>
                ...
                <div class="tab-pane fade" id="cms-privacy" role="tabpanel" aria-labelledby="posting-tab">
                    <x-backend.setting.cms.privacy-policy-setting :privacy="$cms->privacy_body"
                        :privacyBackground="$cms->privacy_background_path" />
                </div>

                {{-- Posting Rules Settings --}}
                <div class="tab-pane fade" id="cms-posting" role="tabpanel" aria-labelledby="posting-tab">
                    <x-backend.setting.cms.posting-rules-setting :rules="$cms->posting_rules_body"
                        :postingRulesBackground="$cms->posting_rules_background_path" />
                </div>
