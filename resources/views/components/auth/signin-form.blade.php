        ...
        <div class="registration-form__wrapper">
            <form action="{{ route('frontend.login') }}" method="POST">
                ...
                <div class="input-field">
                    <input value="{{ old('email') }}" type="text" name="login_data" placeholder="{{ __('username_or_email_address') }}" class="@error('email') is-invalid border-danger @enderror @error('username') is-invalid border-danger @enderror" />
                    @error('email')<span class="text-danger">{{ $message }}</span>@enderror
                    @error('username')<span class="text-danger">{{ $message }}</span>@enderror
                </div>
                <div class="input-field">
                    <input type="password" placeholder="{{ __('password') }}" id="password" name="password" class="@error('password') is-invalid border-danger @enderror" />
