...
@section('content')
    ...
    <section class="banner banner--one section"
        style="background: url('{{ $cms->index2_search_filter_background_path }}') center center/cover no-repeat;">
        <div class="container">
    ...
    @if ($priceplan_enable)
        ...
        <section class="section membership-call">
            <div class="container">
                <div class="membership-call__content"
                    style="background: url('{{ $cms->index2_get_membership_background_path }}') center center/cover no-repeat;">
