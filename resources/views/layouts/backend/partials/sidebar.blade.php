                ...
                @if (Module::collections()->has('Blog'))
                    @if ($blog_enable)
                        @if (userCan('post.view') || userCan('postcategory.view'))
                            <x-sidebar-dropdown
                                :linkActive="Route::is('module.post.*') || Route::is('module.postcategory.*') ? true : false"
                                :subLinkActive="Route::is('module.post.*') || Route::is('module.postcategory.*') ? true : false"
                                icon="fas fa-blog">
                                @slot('title')
                                    {{ __('blog') }}
                                @endslot
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('setting', 'website') }}"
                                    class="nav-link {{ request()->is('admin/settings*') || Route::is('module.currency.*') ? 'active' : '' }}">
