        ...
        <form wire:submit.prevent="storeComment">
            ...
            <div class="input-field__group">
                <div class="input-field">
                    ...
                    <input type="text" id="name" wire:model.defer="name" autocomplete="off" class="@error('name') is-invalid border-danger @enderror" placeholder="{{ __('full_name') }}" />
                    @error('name') <span class="invalid-feedback">{{ $message }}</span>@enderror
                </div>
                <div class="input-field">
                    <x-forms.label name="email" for="email" />
                    <input type="email" wire:model.defer="email" autocomplete="off" class=" @error('email') is-invalid border-danger @enderror" placeholder="{{ __('email_address') }}" id="email" />
            ...
            <div class="input-field--textarea">
                ...
                <textarea wire:model.defer="body" autocomplete="off" class=" @error('body') is-invalid border-danger @enderror" placeholder="{{ __('whats_your_thought') }}..." id="comments"></textarea>
                @error('body') <span class="invalid-feedback">{{ $message }}</span>@enderror
            </div>
            <button onclick="countComments('{{ $post_id }}')" type="submit" class="btn">{{ __('comment') }}</button>
        </form>
    </div>
