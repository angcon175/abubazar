...
->name('customer.password.reset')->middleware('setlang');
...
Route::get('/auth/{provider}/redirect', [SocialLoginController::class, 'redirect'])
    ->where('provider', 'google|facebook|twitter|linkedin|github|gitlab|bitbucket')->middleware('setlang');
...
Route::get('login', [App\Http\Controllers\Auth\Customer\LoginController::class, 'showLoginForm'])
    ->name('customer.login')->middleware('setlang');
Route::get('admin/login', [App\Http\Controllers\Auth\LoginController::class, 'showLoginForm'])
    ->name('admin.login')->middleware('setlang');
