...
Route::get('success-transaction/{plan_id}/{amount}', [PayPalController::class, 'successTransaction'])
    ->name('paypal.successTransaction')->middleware('setlang');
Route::get('cancel-transaction', [PayPalController::class, 'cancelTransaction'])
->name('paypal.cancelTransaction')->middleware('setlang');
...
Route::get('/paystack/success', [PaystackController::class, 'successPaystack'])
    ->name('paystack.success')->middleware('setlang');
