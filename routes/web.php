...
//payment
Route::get('/payment/gateway', 'PaymentController@payment_gateway')->name('payment.gateway');
Route::get('/payment/create', 'PaymentController@getCreate')->name('payment.create');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::get('howto-sell-fast', ['middleware' => 'acl:view_howtosell', 'as' => 'admin.howtosell.fast', 'uses' => 'SettingController@gethowtoSellFast']);
